...
public class UpdateCs extends javax.swing.JFrame {
        ...
        try{
            ...
            while(rs.next()){
                ...
                if(n2.equals(regno)){
                   ...
                   String s1="update cs set name='"+name+"',tamil="+tamil+",english="+english+",maths="+maths+",science="+science+",social="+social+",total="+total+" where regno="+regno+"";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateCs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
